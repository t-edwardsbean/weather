 ...
 */
public class ThinkpageMain {
    public static final Logger log = LoggerFactory.getLogger(ThinkpageMain
            .class);
    ...
    public static void main(String[] args) {
        try {
            ...
            MDC.put("source", "thinkpage-spider");
            Properties p = new Properties();
            p.load(ThinkpageMain.class.getResourceAsStream("/log4j.xml"));
