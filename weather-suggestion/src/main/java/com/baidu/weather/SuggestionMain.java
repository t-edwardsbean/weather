...
public class SuggestionMain {
    public static final Logger log = LoggerFactory.getLogger(SuggestionMain
            .class);
    ...
    public static void main(String[] args) {
        try {
            ...
            MDC.put("source", "suggestion-spider");
            Properties p = new Properties();
            p.load(SuggestionMain.class.getResourceAsStream("/log4j.xml"));
