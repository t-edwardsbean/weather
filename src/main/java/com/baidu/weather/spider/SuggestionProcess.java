...
public class SuggestionProcess implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        if (page.getUrl().regex(FLAG).match()) {
            ...
            dressing.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
...
//            flag.put("flu_details", html.$("section.mask section.gm aside", "text").toString());
            ...
            flu.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
...
//            flag.put("car_washing_details", html.$("section.mask section.xc aside", "text").toString());
            ...
            car.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
            ...
            uv.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
            ...
            glass.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
            ...
            travel.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
            ...
            hair.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
            ...
            exercise.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
            ...
            allergy.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
            ...
            sport.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
            ...
            umbrella.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
            ...
            cosmetic.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
            ...
            comfortable.put("cityname", WeatherManager.fullCity.get(new City(cityId)));
